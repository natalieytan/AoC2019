...
describe("manhattanDistanceIntersectionFinder", () => {
  describe("correctly finds manhattan distance", () => {
    it("matches example A", () => {
      ...
      expect(manhattanDistanceIntersectionFinder(wire1, wire2)).toEqual(6);
    });
    ...
    it("matches example B", () => {
      ...
      expect(manhattanDistanceIntersectionFinder(wire1, wire2)).toEqual(159);
    });
    ...
    it("matches example C", () => {
      ...
      expect(manhattanDistanceIntersectionFinder(wire1, wire2)).toEqual(135);
    });
  });
});

describe("fewestCombinedSteps", () => {
  describe("correctly finds fewest combined steps", () => {
    it("matches example A", () => {
      const wire1 = "R8,U5,L5,D3".split(",");
      const wire2 = "U7,R6,D4,L4".split(",");
